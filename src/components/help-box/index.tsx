...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Hospital Administrator'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Lead Manager', 'Patient Coordinator', 'Medical Staff', 'Hospital Administrator'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `hair mate clinic`;
