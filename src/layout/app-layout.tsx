...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['hospital-administrator', 'lead-manager', 'patient-coordinator', 'medical-staff'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Lead', path: '/leads', entity: 'lead', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
